...
if (!empty($data->idevaluador) && !empty($data->notaPromedio) && !empty($data->tipoevaluacion_idtipoevaluacion) && !empty($data->grupoempresa_idgrupoempresa)) { 
    ...
    try {
        ...
        $query = 'UPDATE evaluacionfinal
	                SET  "notaPromedio"= :notaPromedio
	                WHERE  tipoevaluacion_idtipoevaluacion= :tipoevaluacion_idtipoevaluacion AND grupoempresa_idgrupoempresa= :grupoempresa_idgrupoempresa and idevaluador= :idevaluador';
