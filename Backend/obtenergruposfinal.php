...
try {
    ...
    $query = 'SELECT 
    "GrupoEmpresa"."idGrupoEmpresa", 
    "GrupoEmpresa"."nombreEmpresa",
    "GrupoEmpresa"."logoEmpresa",
    "GrupoEmpresa"."nombreCortoEmpresa"
    FROM 
    "GrupoEmpresa"
    WHERE 
    "GrupoEmpresa"."idDocente" = :idDocente
    AND "GrupoEmpresa"."idGrupoEmpresa" NOT IN (
        SELECT "grupoempresa_idgrupoempresa"
