...
export default function AñadirCriterios() {
    ...
    const handleGuardarCriterio = async (e) => {
        ...
        try {
            const response = await fetch('https://tis-e8f3f498eaee.herokuapp.com/guardarCriterio.php', {
              method: 'POST',
              headers: {
    ...
    const handleEliminarCriterio = async (id) => {
        try {
            const response = await fetch(`https://tis-e8f3f498eaee.herokuapp.com/eliminarCriterio.php?id=${id}`, {
                method: 'DELETE',
            });
