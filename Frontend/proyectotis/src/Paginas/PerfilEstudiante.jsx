    ...
    <>
      ...
      <div className="bg-custom-bg flex" style={{ height: '100vh', marginTop: '70px' }}>
        ...
        <div className="flex justify-center items-center w-full mt-[-100px]">
          <div className="bg-[#1E3664] rounded-[75px] p-12 text-white w-[98%] md:w-[90%] lg:w-[80%] h-[70vh] shadow-2xl flex flex-col lg:flex-row justify-between">
            <div className="flex flex-col mt-6 lg:mt-0">
              <h2 className="text-center font-bold text-3xl mb-6">PERFIL ESTUDIANTE</h2>
